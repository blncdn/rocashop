...
function RegisterForm(_ref) {
  ...
  }, (0,translate._)(" Ein neues Konto erstellen", null)), error && /*#__PURE__*/react.createElement("div", {
    ...
    coreComponents: [{
      component: {
        default: /*#__PURE__*/react.createElement(Field, {
          name: "full_name",
          type: "text",
          placeholder: (0,translate._)(" Vollständiger Name", null),
      ...
      component: {
        default: /*#__PURE__*/react.createElement(Field, {
          name: "password",
          type: "password",
          placeholder: (0,translate._)(" Passwort", null),
          validationRules: ['notEmpty'],
          onChange: e => {
